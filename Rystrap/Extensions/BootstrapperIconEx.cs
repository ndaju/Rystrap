...
namespace Rystrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconRystrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconRystrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconRystrap => Properties.Resources.IconRystrap,
                ...
                BootstrapperIcon.IconRystrapClassic => Properties.Resources.IconRystrapClassic,
                _ => Properties.Resources.IconRystrap
            };
        }
    }
}
