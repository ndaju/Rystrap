...
{
    public partial class RystrapTransparentDialog : IBootstrapperDialog
    {
        private readonly FluentDialogViewModel _viewModel;

        public Rystrap.Bootstrapper? Bootstrapper { get; set; }
        ...
        public RystrapTransparentDialog()
        {
            InitializeComponent();

            _viewModel = new FluentDialogViewModel(this, true);
