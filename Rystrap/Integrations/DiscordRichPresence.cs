...
using Rystrap.Models.RobloxApi;
using DiscordRPC;

namespace Rystrap.Integrations
{
    public class DiscordRichPresence : IDisposable
    {
        ...
        private void ProcessSetRichPresence(Message message, bool implicitUpdate)
        {
            ...
            Models.RystrapRPC.RichPresence? presenceData;
            ...
            try
            {
                presenceData = message.Data.Deserialize<Models.RystrapRPC.RichPresence>();
            }
            catch (Exception)
            {
        ...
        public async Task<bool> SetCurrentGame()
        {
            ...
            // this is used for configuration from RystrapRPC
