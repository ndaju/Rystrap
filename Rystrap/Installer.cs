...
namespace Rystrap
{
    internal class Installer
    {
        ...
        /// </summary>
        private const string ForcedReleaseNotesVersion = "2.11.5";
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs Rystrap, closes it,
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "2.8.0") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "Rystrap");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\Rystrap", false);
...
#pragma warning disable CS0162 // Unreachable code detected
                if (OpenReleaseNotes)
                {
                    ...
                    Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-Rystrap-v{releaseNoteVersion}");
                }
