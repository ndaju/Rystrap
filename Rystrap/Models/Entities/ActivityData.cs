...
using Rystrap.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace Rystrap.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for Rystraprpc, discord rich presence, or game history
