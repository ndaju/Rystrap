...
namespace Rystrap
{
    public static class LaunchHandler
    {
        ...
        public static void LaunchBackgroundUpdater()
        {
            ...
            App.Bootstrapper = new Bootstrapper(launchMode)
            {
                MutexNamePrefix = "Rystrap-BackgroundUpdater",
            ...
            Task.Run(() =>
            {
                ...
                using (EventWaitHandle handle = new EventWaitHandle(false, EventResetMode.AutoReset, "Rystrap-BackgroundUpdaterKillEvent"))
                    handle.WaitOne();
